...
* Model "S" - Station
c(S_profit)..                            OF =e= sum(t$hours(1),Lambda(t)*(q(t)+q(t+1)+q(t+2)+q(t+3)) ) + sum(t,b_deg(t))
                                              + z*Gamma + sum(t$hours(1),omega(t));

c(S_robust1(t))$hours(1)..                  z + omega(t) =g= Delta_lambda(t)*y(t);

c(S_robust2_1(t))$hours(1)..               -y(t) =l= q(t)+q(t+1)+q(t+2)+q(t+3);
c(S_robust2_2(t))$hours(1)..                q(t)+q(t+1)+q(t+2)+q(t+3) =l= y(t);
...
execute_unload 'day_ahead_decisions.gdx' q;
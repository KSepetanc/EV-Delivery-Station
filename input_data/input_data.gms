$eolCom //
set t 15 min time periods /t1*t96/;      //Time period can be increased up to t672, but increase the N_start so the model is feasable.
...
$gdxin ..\input_data\Transport_station.gdx
...
parameter Delta/60/;        //Battery degradation cost, €/MWh
